...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/tools/plain-language", label: "Plain-Language Translator" },
      { href: "/tools/iep-companion", label: "IEP / 504 Companion" },
      { href: "/tools/regulation-toolkit", label: "Regulation Toolkit" },
