...
const TOOLS = [
  ...
  },
  {
    ...
    tagline: "Decode jargon-y letters, reports, and forms",
    desc: "Paste a school evaluation, clinical letter, or insurance denial and get a friendlier, jargon-free version. Local-first.",
  ...
  },
  {
    ...
    desc: "Wizard through strengths, challenges, accommodations, and talking points; export a printable one-pager.",
  ...
  },
  {
    ...
    tagline: "Tools tuned to how you're feeling now",
    desc: "Three quick questions surface five evidence-informed regulation strategies, plus a built-in box-breathing companion.",
  ...
  },
  {
    ...
    tagline: "Plan calmer days; spot the trouble zones",
    desc: "Map a day in time blocks, tag each block's sensory load and triggers, get warnings before the meltdown.",
