...
const TOOLS = [
  ...
  },
  {
    ...
    desc: "Identify sensory triggers, build supportive routines, and share them with caregivers, teachers, or therapists.",
    href: "/tools",
    badge: "Coming soon",
  ...
  },
  {
    ...
    desc: "Step through accommodation menus, draft talking points, and export a clean one-pager for your next meeting.",
    href: "/tools",
    badge: "Coming soon",
    badgeClass: "bg-cream-200 text-slate-700",
  ...
  },
  {
    ...
    desc: "Paste a school report, evaluation, or insurance letter and get a friendlier, jargon-free version with optional kid-friendly mode.",
    href: "/tools",
    badge: "Coming soon",
    badgeClass: "bg-cream-200 text-slate-700",
